...
internal fun JvmApplicationContext.configurePlatformSettings(
    ...
    packageTask.dependsOn(unpackDefaultResources)
    app.nativeDistributions.linux.also { linux ->
        packageTask.shortcut.set(provider { linux.shortcut })
        packageTask.appCategory.set(provider { linux.appCategory })
        packageTask.appRelease.set(provider { linux.appRelease })
        packageTask.debPackageVersion.set(provider { linux.debPackageVersion })
        packageTask.debMaintainer.set(provider { linux.debMaintainer })
        packageTask.menuGroup.set(provider { linux.menuGroup })
        packageTask.linuxPackageName.set(provider { linux.packageName })
        ...
        packageTask.debPreInst.set(linux.debPreInst)
        packageTask.debPostInst.set(linux.debPostInst)
        packageTask.debPreRm.set(linux.debPreRm)
        packageTask.debPostRm.set(linux.debPostRm)
...
internal fun JvmApplicationContext.configurePlatformSettings(
    ...
    app.nativeDistributions.windows.also { win ->
        packageTask.console.set(provider { win.console })
        packageTask.dirChooser.set(provider { win.dirChooser })
        packageTask.perUserInstall.set(provider { win.perUserInstall })
        packageTask.shortcut.set(provider { win.shortcut })
        packageTask.menuGroup.set(provider { win.menuGroup })
        packageTask.upgradeUuid.set(provider { win.upgradeUuid })
        packageTask.aumid.set(provider { win.aumid })
        packageTask.packageVersion.set(provider { win.packageVersion })
